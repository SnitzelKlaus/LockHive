...
/// <summary>
/// Exception thrown by the GetUserPasswords service.
/// </summary>
internal class GetUserPasswordsServiceException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetUserPasswordsServiceException"/> class with a specified error message.
    /// </summary>
