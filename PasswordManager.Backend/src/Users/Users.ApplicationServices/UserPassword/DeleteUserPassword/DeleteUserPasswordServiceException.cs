...
{
    /// <summary>
    /// Exception thrown by the DeleteUserPassword service.
    /// </summary>
    public class DeleteUserPasswordServiceException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteUserPasswordServiceException"/> class with a specified error message
