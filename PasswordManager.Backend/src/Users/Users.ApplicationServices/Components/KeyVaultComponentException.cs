...
/// <summary>
/// Represents an exception that occurs within the key vault component of the application.
/// </summary>
public class KeyVaultComponentException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyVaultComponentException"/> class with a specified error message
