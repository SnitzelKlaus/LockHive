...
public class Operation : BaseModel
{
    ...
    public Operation(Guid id, string requestId, string createdBy, Guid passwordId, OperationName name,
    ...
    public Operation(string createdBy, Guid passwordId, OperationName name, OperationStatus status)
    {
        Id = Guid.NewGuid();
